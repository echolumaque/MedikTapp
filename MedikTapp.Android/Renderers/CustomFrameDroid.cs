...
[assembly: ExportRenderer(typeof(CustomFrame), typeof(CustomFrameDroid))]
namespace MedikTapp.Droid.Renderers
{
    public class CustomFrameDroid : FrameRenderer
    {
        public CustomFrameDroid(Context context) : base(context) { }
