...
{
    /// <summary>
    /// This is a Navigation Parameters class used for Dialog Parameters and Navigation Parameters.
    /// </summary>
    public class NavigationParameters : IEnumerable<KeyValuePair<string, object>>
    {
        ...
        public object this[string key]
        {
            get
            {
                foreach (var entry in _entries.Where(entry => string.Compare(entry.Key, key, StringComparison.Ordinal) == 0))
                    return entry.Value;
